...
public class OnOff extends Controller implements OnCheckedChangeListener{
	...
	public OnOff(Context context, Element element) {
		this(context, ControllerType.ON_OFF_SWITCH, element);
	}

	public OnOff(Context context, ControllerType type, Element element) {
		super(context, element, type, type.getLayout());
		changeBackgroundColorByState = true;
	...
	private void initViews(){
		...
		switchView = (CompoundButton)getMainView().findViewById(android.R.id.toggle);
