...
function updateCompoundButtonValue(controllerid, value){
	var button = $("#"+controllerid).find(".compound-button");
	if(value == "on"){
		setCompoundButtonViewOn(button);
	}else if(value == "off"){
		setCompoundButtonViewOff(button);
	}
}
...
function setCompoundButtonViewOn(button){
...
function setCompoundButtonViewOff(button){
...
function updateSliderValue(controllerid, value){
	var slider = $("#"+controllerid).find(".controller-slider");
	var isLightSlider = $(slider).hasClass("light-controller-slider");
	if(isLightSlider){
		setSliderImage(slider, value);
	}else{
...
function updateValueViewerValue(controllerid, value){
	var  viewer = $("#"+controllerid).find(".controller-value");
	$(viewer).html(value);
